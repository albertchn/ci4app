                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group mb-2">
                            <input type="file" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" name="sampul" onchange="previewImg()" placeholder="<?= $komik['sampul']; ?>">
                            <label class="input-group-text" for="sampul">Ubah</label>
